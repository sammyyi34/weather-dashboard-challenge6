...
function todayWeatherInfo() {
  ...
  .then(function(data) {
    ...
    getFiveDay(cityName)
    day1IconEl.src = '';
    day1TempEl.innerHTML = 'Temp:';
    day1WindEl.innerHTML = 'Wind:';
    day1HumidityEl.innerHTML = 'Humidity:';
    day2IconEl.src = '';
    day2TempEl.innerHTML = 'Temp:';
    day2WindEl.innerHTML = 'Wind:';
    day2HumidityEl.innerHTML = 'Humidity:';
    day3IconEl.src = '';
    day3TempEl.innerHTML = 'Temp:';
    day3WindEl.innerHTML = 'Wind:';
    day3HumidityEl.innerHTML = 'Humidity:';
    day4IconEl.src = '';
    day4TempEl.innerHTML = 'Temp:';
    day4WindEl.innerHTML = 'Wind:';
    day4HumidityEl.innerHTML = 'Humidity:';
    day5IconEl.src = '';
    day5TempEl.innerHTML = 'Temp:';
    day5WindEl.innerHTML = 'Wind:';
    day5HumidityEl.innerHTML = 'Humidity:';
  })
}
